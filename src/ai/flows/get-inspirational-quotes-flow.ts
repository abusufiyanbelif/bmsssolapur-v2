...
const getInspirationalQuotesFlow = ai.defineFlow(
    ...
    async ({count}) => {
        ...
        try {
            ...
            allQuotes = [
                { id: '1', text: "The believer's shade on the Day of Resurrection will be their charity.", source: "Tirmidhi", category: "Hadith" },
                { id: '2', text: "Charity does not decrease wealth.", source: "Sahih Muslim", category: "Hadith" },
                { id: '3', text: "And be steadfast in prayer and regular in charity: And whatever good ye send forth for your souls before you, ye shall find it with Allah.", source: "Quran 2:110", category: "Quran" },
            ];
        }
