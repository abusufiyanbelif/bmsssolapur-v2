...
import { 
    ...
    Database, Building, Award, ChevronDown, Shield, KeySquare, Group, BookOpenCheck, ArrowRightLeft, LayoutDashboard, Workflow, UserSearch, CreditCard, BellRing, MessageSquare, Newspaper, ScanSearch, PlusCircle, Binary, Palette, History, Layout, HardDrive, View, Edit
} from "lucide-react"
...
const allNavItems: NavItem[] = [
    ...
    // Admin - Organization (Collapsible)
    {
        ...
        subItems: [
            { href: "/admin/organization-profile", label: "Edit Profile & Layout", icon: Edit, allowedRoles: ["Admin", "Super Admin", "Finance Admin"] },
            { href: "/admin/organization-view", label: "Organization View", icon: View, allowedRoles: ["Admin", "Super Admin", "Finance Admin"] },
