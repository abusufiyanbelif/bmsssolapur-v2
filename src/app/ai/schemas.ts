...
export const ExtractLeadDetailsOutputSchema = z.object({
    ...
    dueDate: z.string().optional().describe("The date by which the funds are needed, formatted as a full ISO 8601 string (YYYY-MM-DDTHH:mm:ss.sssZ)."),
    caseReportedDate: z.string().optional().describe("The date the case was reported or the document was issued, formatted as a full ISO 8601 string (YYYY-MM-DDTHH:mm:ss.sssZ)."),
    ...
    dateOfBirth: z.string().optional().describe("The beneficiary's date of birth, formatted as a full ISO 8601 string (YYYY-MM-DDTHH:mm:ss.sssZ)."),
...
export const ExtractDonationDetailsOutputSchema = z.object({
  ...
  date: z.string().optional().describe("The date of the transaction, formatted as a full ISO 8601 string (YYYY-MM-DDTHH:mm:ss.sssZ)."),
