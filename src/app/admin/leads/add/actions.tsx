...
export async function handleAddLead(
  ...
  if (!rawFormData.purpose || isNaN(rawFormData.helpRequested)) {
  ...
  try {
    ...
    const newLeadData: Omit<Lead, 'id' | 'createdAt' | 'updatedAt' | 'helpGiven' | 'status' | 'verifiedStatus' | 'verifiers' | 'dateCreated' | 'adminAddedBy' | 'category' | 'donations' | 'otherCategoryDetail'> = {
