...
export async function handleUpdateUserConfiguration(
  ...
  try {
    ...
    const userConfig: AppSettings['userConfiguration'] = {
      ...
      Donor: {
        ...
        isPhoneMandatory: formData.get("Donor.isPhoneMandatory") === 'on',
      },
      Beneficiary: {
        ...
        isPhoneMandatory: formData.get("Beneficiary.isPhoneMandatory") === 'on',
      },
      Referral: {
        ...
        isPhoneMandatory: formData.get("Referral.isPhoneMandatory") === 'on',
      },
       Admin: {
        ...
        isPhoneMandatory: formData.get("Admin.isPhoneMandatory") === 'on',
      },
    };
    ...
    revalidatePath("/admin/user-management/add");
