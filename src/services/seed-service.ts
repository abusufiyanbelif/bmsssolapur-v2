...
const adminUsersToSeed: Omit<User, 'id' | 'createdAt'>[] = [
    ...
    { name: "Muddasir", firstName: "Muddasir", email: "muddasir@example.com", phone: "7385557820", password: "admin", roles: ["Admin"], privileges: ["canManageLeads"], groups: ["Member of Organization"], isActive: true, gender: 'Male', address: { city: 'Solapur', state: 'Maharashtra', country: 'India' } },
